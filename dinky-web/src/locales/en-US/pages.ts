...
export default {
  ...
  'sys.plugin.market.install': 'Install plugins',
  'sys.plugin.market.installConfirm': 'Are you sure you want to install this plugin？',
  'sys.plugin.market.installed': 'Already Installed',
  'sys.plugin.market.uninstalled': 'Not installed',
  'sys.plugin.market.download': 'Download plugins',
  'sys.plugin.market.downloaded': 'Downloaded',
  'sys.plugin.market.notDownloaded': 'Not downloaded',
  'sys.plugin.market.install.download.info': 'Plugin situation',
  'sys.plugin.market.install.info': 'Download status',
  'sys.plugin.market.download.info': '安装情况Installation situation',
  'sys.plugin.market.name': 'Plugin Name',
  'sys.plugin.market.pluginId': 'Plugin ID',
  'sys.plugin.market.downloadUrl': 'Download URL',
  'sys.plugin.market.localStorageFullPath': 'Local storage path',
  'sys.plugin.market.resourceStorageFullPath': 'Resource storage path',
  'sys.plugin.market.organization': 'Organization',
  'sys.plugin.market.repositoryId': 'Repository ID',
  'sys.plugin.market.pluginReleaseTimestamp': 'Release Time',
  'sys.plugin.market.description': 'Description',
  'sys.plugin.market.versionCount': 'Version Count',
  'sys.plugin.market.pluginInfo': 'Plugin Information',
  'sys.plugin.market.enable': 'The plugin marketplace feature is not enabled',
  'sys.plugin.market.enable.tips':
    'Please go to [Configuration Center ->Global Configuration ->Maven Configuration] to enable the plugin marketplace feature!!!',
  /**
   *
   * tenant
   *
